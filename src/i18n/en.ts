...
export const en = {
  ...
  "settings.ragExternalIndexPath": "External index path",
  "settings.ragExternalIndexPathDesc": "Absolute path to a directory containing rag-index.json and rag-vectors.bin",
  "settings.ragExternalIndexPathPlaceholder": "e.g. /path/to/indexes/domain",
