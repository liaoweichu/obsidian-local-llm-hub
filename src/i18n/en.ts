...
export const en = {
  ...
  "settings.ragExternalIndexPathDesc": "Absolute path to external index directory (empty = use local vault index)",
  "settings.ragExternalIndexPathPlaceholder": "/path/to/index-dir",
