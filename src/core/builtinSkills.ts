...
3. **Create the file** — use \`create_note\` with \`path: "Dashboards/<Name>.dashboard"\`.
   The content is YAML (schema below).
...
- [ ] Widgets don't overlap (increase \`y\` to stack)`,
  ...
  references: [
    `[BASE_SKILL.md]\n${OBSIDIAN_BASES.instructions}`,
    ...OBSIDIAN_BASES.references,
  ],
};
