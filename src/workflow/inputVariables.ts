...
import { ALL_EVENT_VARIABLE_NAMES } from "./eventVariables";
 ...
 * when generating / updating a skill so `SKILL.md`'s `skill-capabilities`
 * block stays in sync with the workflow the author actually wrote.
 */
